...
planets = [
    ...
    Moon(earth, 3.0, 30, "#cccccc", None, 0),  # Moon (slightly faster)

    mars := Planet(130.0, 220, "#b54c32", 0),
    Moon(mars, 1.4, 10, "#aaaaaa", None, 0),   # Phobos
    Moon(mars, 1.4, 8, "#999999", None, 0),    # Deimos

    jupiter := Planet(200.0, 500, "#d9a066", 0),
    Moon(jupiter, 3.0, 34, "#aaaaaa", None, 0),   # Io
    Moon(jupiter, 3.1, 32, "#999999", None, 0),   # Europa
    Moon(jupiter, 3.2, 36, "#bbbbbb", None, 0),   # Ganymede
    Moon(jupiter, 3.3, 40, "#dddddd", None, 0),   # Callisto

    saturn := Planet(250.0, 600, "#f5d76e", 0),
    Moon(saturn, 3.48, 38, "#eeeeee", None, 0),    # Titan
    Moon(saturn, 2.76, 26, "#aaaaff", None, 0),    # Enceladus

    uranus := Planet(300.0, 700, "#6db7c6", 0),
    Moon(uranus, 3.06, 28, "#dddddd", None, 0),    # Titania
    Moon(uranus, 2.57, 22, "#bbbbdd", None, 0),    # Oberon

    neptune := Planet(350.0, 800, "#3457d5", 0),
    Moon(neptune, 2.94, 26, "#cccccc", None, 0),   # Triton
]
